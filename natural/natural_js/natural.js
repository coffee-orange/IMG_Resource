    ...
    window.onscroll = function(){
        if(checkFlag()){
            ...
            for(var i=0; i<imgData.data.length; i++){
                ...
                img.src = "natural_images/natural"+imgData.data[i].src+".jpg";
                boximg.appendChild(img);

                var hiddenBox = document.createElement("div");
                hiddenBox.className="hidden_box";
                boximg.appendChild(hiddenBox);

                var a = document.createElement("a");
                a.href="#";
                a.className="aicon";
                a.download="natural"+imgData.data[i].src +".jpg";
                hiddenBox.appendChild(a);
                ...
                p.className="naturalWord";
                hiddenBox.appendChild(p);
                p.innerHTML="Natural Scenery Material "+imgData.data[i].src;
